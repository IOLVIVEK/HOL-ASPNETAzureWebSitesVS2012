...
The **Building and Publishing ASP.NET Applications with Windows Azure Web Sites and Visual Studio 2012 Hands-on Lab** is licensed under the terms of the Apache License, Version 2.0.
